...
Make `/setup-utarn-skills` friendlier and align the local-markdown tracker with the current spec.
...
Docs pages for `setup-utarn-skills` and `to-tickets` re-synced.
