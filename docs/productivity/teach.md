...
```bash
npx skills add utarn/engineer-skills --skill=teach
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/teach)
