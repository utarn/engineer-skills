...
```bash
npx skills add utarn/engineer-skills --skill=grilling
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling)
...
Reach for it when a plan or design still has soft spots and you want them surfaced before code is written. In practice you usually invoke it through one of its two wrappers rather than by name: for a plain grilling session use [grill-me](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grill-me/SKILL.md); to have the session also write ADRs and a glossary as it goes, use [grill-with-docs](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/grill-with-docs/SKILL.md).
...
`grilling` is the **single source of truth** for the interview technique, split out as a model-invoked **primitive** so every skill that needs an interview can reach it instead of reinventing one. [grill-me](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grill-me/SKILL.md) and [grill-with-docs](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/grill-with-docs/SKILL.md) are its two user-invoked front doors, but [improve-codebase-architecture](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/improve-codebase-architecture/SKILL.md) and [triage](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/triage/SKILL.md) also lean on it to pressure-test their own decisions.
...
`grilling` is the interview **primitive** under the main build chain: [grill-with-docs](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/grill-with-docs/SKILL.md) runs it to sharpen context before [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md) writes the spec. When you're unsure which entry point fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
