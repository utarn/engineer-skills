...
```bash
npx skills add utarn/engineer-skills --skill=writing-great-skills
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/writing-great-skills)
...
This is a reach-for-it-anytime standalone reference — the meta-skill you consult while building the rest of the set, not a step in a chain. Its natural neighbour is any router you maintain, because a router is the direct cure for the cognitive load that user-invoked skills pile up; when you're unsure which skill or flow fits a task, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you over the whole set.
