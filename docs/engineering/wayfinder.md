...
```bash
npx skills add utarn/engineer-skills --skill=wayfinder
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/wayfinder)
...
Reach for it when an effort is **more than one agent session can hold** and the route to its **destination** is still foggy — you can feel the shape of the work but can't yet write it down as a spec or a plan. For turning an *already-clear* thread into a spec, use [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md); for slicing an already-understood plan into buildable tickets, use [to-tickets](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-tickets/SKILL.md). Wayfinder sits upstream of both: it's what you run when there's too much fog to spec directly.

## Prerequisites

The map and its tickets live on the repo's issue tracker, so wayfinder needs the tracker wiring that [setup-utarn-skills](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/setup-utarn-skills/SKILL.md) lays down — it seeds a "Wayfinding operations" section describing how the map, child tickets, blocking, and frontier queries are expressed for GitHub, GitLab, or local-markdown. Absent that doc, wayfinder defaults to a local-markdown map.
...
`wayfinder` is a big-idea **on-ramp**: an effort too large and foggy to spec in one sitting generates a cleared map of decisions, which then merges onto the main build flow. When the fog is pushed back and the way is clear, hand off to [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md) to schedule the multi-session build (or, if the effort turned out small, implement directly). It leans on [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md) and [domain-modeling](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/domain-modeling/SKILL.md) to resolve individual tickets, and on [prototype](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/prototype/SKILL.md) and [research](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/research/SKILL.md) for the ticket types that need them. When you're unsure which skill or flow fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
