...
```bash
npx skills add utarn/engineer-skills --skill=research
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/research)
...
Reach for it when the next step is *finding something out* — how an API behaves, what a spec actually says, whether a claim holds — and you'd rather not stall your own thread doing the reading. For sharpening a plan by interview instead of by reading, use [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md); for exploring what to build with throwaway code, use [prototype](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/prototype/SKILL.md).
...
A reach-for-it-anytime standalone that feeds the thinking skills: the file it produces is something to grill, plan, or design against, so it sits upstream of work like [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md) and [to-prd](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-prd/SKILL.md) rather than in the build chain. For the whole map, see [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md).
