...
```bash
npx skills add utarn/engineer-skills --skill=tdd
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/tdd)
...
Reach for it when there's a concrete behaviour to build and you want tests that survive a refactor. If the behaviour isn't pinned down yet, settle the spec first — for that, use [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md). When the work is really about the shape of the interface rather than the tests, use [codebase-design](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/codebase-design/SKILL.md); `tdd` calls into it for the deep-module vocabulary during planning.
...
[implement](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/implement/SKILL.md) is the chain's build step, and it drives `tdd` internally to build each ticket test-first before handing off to [code-review](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/code-review/SKILL.md) — so `tdd` is the engine inside that step rather than a step of its own. You can also reach for it directly, whenever there's a concrete behaviour to build without a full spec. Its other neighbour is [codebase-design](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/codebase-design/SKILL.md), which it leans on to find deep-module seams worth testing at. When you're unsure which skill or flow fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
