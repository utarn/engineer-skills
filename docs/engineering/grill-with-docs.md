...
```bash
npx skills add utarn/engineer-skills --skill=grill-with-docs
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/grill-with-docs)
...
Reach for it at the very start of a change, when the plan is still fuzzy and the domain language isn't settled, and you want to stress-test both before any code exists. If you only want the interview and don't need the artifacts, use [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md); if the plan is already clear and you just need to pin down or record terminology, use [domain-modeling](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/domain-modeling/SKILL.md). And if the change is too big to hold in one session and its route is still foggy — a greenfield project, a huge feature build — start upstream with [wayfinder](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/wayfinder/SKILL.md): it charts the effort as a map of decisions, then hands back to this main flow once the way is clear.
...
It comes first, before anything is written down as a spec: it produces the shared understanding and settled vocabulary that [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md) then synthesises into a spec without re-interviewing you. Its close neighbours are [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md), the same interview without the docs, and [domain-modeling](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/domain-modeling/SKILL.md), the glossary-and-ADR discipline it drives. When you're unsure which skill or flow fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
