...
```bash
npx skills add utarn/engineer-skills --skill=to-spec
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec)
...
Reach for it after the plan and domain language are resolved, and before you break the work into implementation tickets. Its key neighbours are [grill-with-docs](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/grill-with-docs/SKILL.md), which sharpens the context so the spec is precise, and [to-tickets](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-tickets/SKILL.md), which turns the spec into a set of tickets for [implement](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/implement/SKILL.md) to build. When you're unsure which skill or flow fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
