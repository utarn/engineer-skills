...
```bash
npx skills add utarn/engineer-skills --skill=prototype
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/prototype)
