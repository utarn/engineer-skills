...
```bash
npx skills add utarn/engineer-skills --skill=improve-codebase-architecture
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/improve-codebase-architecture)
...
Then it stops and asks which one you want to explore. Pick one and it runs the [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md) loop over that design — constraints, what sits behind the seam, which tests survive — updating the domain model inline as decisions crystallise.

## Where it fits

`improve-codebase-architecture` is **periodic maintenance** — run it every few days, not as a step in a chain. Its neighbours are [codebase-design](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/codebase-design/SKILL.md), which owns the depth-and-seam vocabulary every candidate is written in, [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md), which walks the decision tree once you've chosen a candidate, and [domain-modeling](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/domain-modeling/SKILL.md), which keeps `CONTEXT.md` and the ADRs current as the redesign settles. When you're unsure which skill or flow fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
