...
```bash
npx skills add utarn/engineer-skills --skill=domain-modeling
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/domain-modeling)
...
Reach for it when the *words* are the problem: two people mean different things by "cancellation", "account" is doing three jobs, or a design conversation keeps snagging on a concept that has never been named precisely. If instead the module's *shape* is the problem — where the seam goes, how deep the interface is — use [codebase-design](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/codebase-design/SKILL.md). If you want the plan itself interrogated before you build, use [grilling](https://github.com/utarn/engineer-skills/tree/main/skills/productivity/grilling/SKILL.md).
...
`domain-modeling` is the **single source of truth** for building the project's ubiquitous language, split out as its own model-invoked skill so any other skill can reach it. [grill-with-docs](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/grill-with-docs/SKILL.md) leans on it to record terms and decisions as a grilling session runs, [triage](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/triage/SKILL.md) uses it to keep tickets in the project's own words, and [improve-codebase-architecture](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/improve-codebase-architecture/SKILL.md) reaches for it while it works.
...
`domain-modeling` is a **reach-for-it-anytime standalone** that runs *underneath* other skills as often as at a fixed step. Its closest neighbour is [codebase-design](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/codebase-design/SKILL.md), because a shared language is what lets you name a deep module and its seam precisely; downstream, a settled glossary is exactly what [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md) synthesises into a spec written in the project's own words. When you're unsure which skill or flow fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
