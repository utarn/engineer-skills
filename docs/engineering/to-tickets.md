...
```bash
npx skills add utarn/engineer-skills --skill=to-tickets
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-tickets)
...
It sits between [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md), which hands it a settled spec with user stories to slice against, and [implement](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/implement/SKILL.md), which builds each ticket, driving [tdd](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/tdd/SKILL.md) internally to write the tests test-first, before its [code-review](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/code-review/SKILL.md) pass. Work the frontier one ticket per fresh context, clearing between them. When you're unsure which skill or flow fits, [ask-utarn](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/ask-utarn/SKILL.md) routes you.
