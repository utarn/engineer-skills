...
```bash
npx skills add utarn/engineer-skills --skill=codebase-design
```
...
[Source](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/codebase-design)
...
`codebase-design` is the **single source of truth** for the deep-module vocabulary, split out as its own model-invoked skill so anything can reach it. Other skills point at it rather than restating the words: [tdd](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/tdd/SKILL.md) borrows it to place a seam before writing the test, [improve-codebase-architecture](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/improve-codebase-architecture/SKILL.md) leans on it while restructuring existing code, and [to-spec](https://github.com/utarn/engineer-skills/tree/main/skills/engineering/to-spec/SKILL.md) speaks it when it sketches seams and deepening opportunities before writing a spec.
